...
import (
	...
	"github.com/StealthBadger747/KubeNodeSmith/internal/controller"
...
func init() {
	...
	utilruntime.Must(kubenodesmithv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err := (&controller.NodePoolReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("nodepool-controller"),
